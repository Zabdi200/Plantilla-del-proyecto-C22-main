...
function setup() {
    ...
    playerArcher = Bodies.rectangle(223, 230, 100, 130, options);
...
function draw() {
    ...
    textAlign("center");
    textSize(40);
    text("TIRO CON ARCO", width / 2, 100);
    image(playerArcherimage, playerArcher.position.x, playerArcher.position.y, 100, 130);
}